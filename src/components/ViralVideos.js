            ...
            <div className="flex flex-col max-w-[1280px] w-full">
                <div className="">
                    <div className="flex flex-col xl:flex-row  xl:justify-between">
                        <div className="text-white text-6xl font-bold text-center">MORNITORING HUB</div>
                        <div className="mt-6 xl:mt-0 flex flex-row self-center">
                            <div
                                onClick={() => setTab(1)}
                                className={`${tab===1?"bg-white text-black":"text-white hover:text-black hover:bg-white"} px-4 py-2  flex items-center justify-center  text-sm text-center  hover:cursor-pointer border-2 border-white rounded-full`}>REVIEWS</div>
                            <div
                                onClick={() => setTab(2)}
                                className={`${tab===2?"bg-white text-black":"text-white hover:text-black hover:bg-white"} mx-4 px-4 py-2  flex items-center justify-center  text-sm text-center  hover:cursor-pointer border-2 border-white rounded-full`}>VIDEOS</div>
                            <div
                                onClick={() => setTab(3)}
                                className={`${tab===3?"bg-white text-black":"text-white hover:text-black hover:bg-white"} px-4 py-2  flex items-center justify-center  text-sm text-center  hover:cursor-pointer border-2 border-white rounded-full`}>ARTICLES</div>
                        </div>
                    </div>
                </div>
                {tab === 1
                    ? <> <div className="mt-12 flex flex-row text-white">
                        <div className="w-full flex flex-col xl:flex-row justify-between items-center">
                            <div className='max-w-[630px] xl:self-start'>
                                ...
                                <div
                                    className='mt-6 text-white font-barlow-condensed text-center  text-5xl font-medium leading-10'>FORD RANGER REVIEW</div>

  ...
  const handleCheckboxChange = (id) => {
    ...
    return(
        ...
        <div className="mt-8 flex flex-col">
            <div className="text-gray-900 font-barlow-condensed text-32 font-bold leading-40 uppercase scale-y-125  uppercase">buy in full now</div>
        ...
        <div className="mt-8 text-gray-900 font-barlow-condensed text-32 font-bold leading-40 uppercase scale-y-125  flex flex-col uppercase">your contact informations</div>
        ...
        <div className="mt-8 text-gray-900 font-barlow-condensed text-32 font-bold leading-40 uppercase scale-y-125  uppercase ">your address</div>
        ...
        <input type="text" placeholder="2DUS 7 VI" className="mt-2 bg-[#f6f6f6] px-6 py-3 border-2 w-full rounded-full"></input>
        <div className="mt-4 w-full flex flex-col md:flex-row md:justify-between">
            <div className="flex flex-col w-full md:w-[45%]">

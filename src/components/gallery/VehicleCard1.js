...
export function VehicleCard1({item}) {
    ...
    return (
        <div className='  md:max-w-[300px] w-full flex flex-col mt-8 mx-3 min-w-[280px] rounded-lg overflow-hidden'> 
            ...
            <div className=" text-neutral-700 text-base font-normal font-['Barlow'] leading-normal">
                {desc}
            </div>

            <div className=' my-4 flex flex-wrap justify-between'>
                <div className="m-2 flex-row min-w-[50px] justify-between items-center bg-white rounded-full px-2 py-1">
                ...
                <div className="m-2 text-gray-700 font-barlow text-12 font-medium leading-17 bg-white rounded-full px-2 py-1">
                    <div className="flex flex-row justify-between items-center ">
                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">

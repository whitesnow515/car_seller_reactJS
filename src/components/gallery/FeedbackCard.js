        ...
        <Modal
            ...
            <div className="flex justify-between ">
                <div
                    ...
                    <div className="flex">
                        <Rating value={5}/>
                        <Typography variant='h6' className="ml-2">4.9/5.0 </Typography>
                        <FeefoSVG/>
            ...
            <div
                className="w-full justify-between flex-col sm:flex-row items-center gap-2 py-3 flex">
                <div className="flex gap-3 w-full sm:w-fit">
                    <div
                        className="px-4  w-1/2 sm:w-fit cursor-pointer py-3 bg-gray-800 hover:bg-gray-900 rounded-full justify-center items-center gap-2 flex">
                        <div
                            className="text-white text-sm font-semibold font-['Barlow'] uppercase tracking-tight">Newest</div>
                    </div>
                    <div
                        className="px-4 py-3  w-1/2 sm:w-fit cursor-pointer bg-white hover:bg-gray-100 rounded-full border border-gray-800 justify-center items-center gap-2 flex">
                        <div
                            className="text-gray-800 text-sm font-semibold font-['Barlow'] uppercase  tracking-tight">popular</div>
                    </div>
                </div>
                <div
                    className="rounded-full w-full sm:w-fit pl-4 border border-gray-400 float-right items-end">
                    <Select label="ALL RATINGS" variant="standard" className="border-0 py-0">
...
export function FeedbackCard() {
    ...
    return (
        <Card
            color="transparent"
            shadow={false}
            className="relative py-[46px] px-[96px] lg:w-[1100px] lg:border-b-[1px] border-gray-200">
            <CardHeader
                color="transparent"
                floated={false}
                shadow={false}
                ...
                {/* <Avatar
                    ...
                    alt="tania andrew"/> */}
                <ReviewModal open={open} setOpen={setOpen} data={reviewData}/>
                ...
                <div className="hidden lg:flex w-full gap-0.5 justify-center items-center">
                    <div className="hidden lg:flex flex-col gap-0.5">
                        ...
                        <div className="flex flex-row items-center justify-center">
                            <div className='text-xs font-black text-gray-500 pr-1'>Independent Service Rating</div>
                            <div className='text-xs font-normal text-gray-500 pr-1'>based on</div>
                            <div className='text-xs font-black text-gray-500 pr-1'>791</div>
                            <div className='text-xs font-black text-gray-500 pr-1'>verified reviews.</div>
                            <div
                                onClick={() => setOpen(true)}
                                className='text-xs font-bold text-blue-600 cursor-pointer'>
                                Read all reviews</div>
                        </div>
                    </div>
                    <div className="hidden lg:flex w-[120px]">
                        <img
                            ...
                            className="ignore-purify-1h0Ih  ignore-purify-2n3Sp w-1/2"></img>
                        {/* <div className='relative h-fit w-1/2 z-10'> */}
                        <img src={carguru} alt="sellcars" className="w-[70px] h-[60px] pl-1"/> {/* </div> */}
                    </div>
                </div>

                <div className='flex flex-col max-lg:w-[320px] max-lg:px-[15px] lg:hidden'>
                    {/* <div className='flex w-full mb-[15px] pb-[15px] border-b-[1px] border-gray-200'>
                        <div className='w-[190px]'>
                            <div className="5 flex items-center gap-0 w-4/5">
                                <StarIcon size={30}/>
                                <StarIcon size={30}/>
                                <StarIcon size={30}/>
                                <StarIcon size={30}/>
                            ...
                            <div className='flex'>
                                <div className='text-[28px] font-black'>4.9</div>
                                <div className='text-[28px] font-normal'>/5</div>
                            </div>
                            <div className='text-xs font-black text-gray-500 pr-1'>Independent Service Rating</div>
                            <div className="flex ">
                                <div className='text-xs font-normal text-gray-500 pr-1'>based on</div>
                    ...
                    <div className="text-center py-4">
                        ...
                        <p onClick={() => setOpen(true)} className='text-xs font-bold text-blue-600 cursor-pointer'>
                            Read all reviews
                        </p>
                    </div>

        ...
        <Tabs value={activeTab} className="w-full">
            <TabsHeader
                ...
                <div className="pb-8 lg:pb-0 flex flex-wrap justify-center items-center">
                    <h1 className="text-gray-800 text-center scale-y-125 font-barlow-condensed text-6xl font-bold leading-10 uppercase tracking-tighter">
                        {props.title1}
                    </h1>
                    <h1 className="mt-10 md:mt-0 text-center md:text-left text-transparent bg-gradient-to-r from-red-500 to-blue-500 bg-clip-text font-barlow-condensed text-6xl scale-y-125  font-bold leading-tight uppercase tracking-tighter">
                        &nbsp;{props.title2}
                    </h1>
                </div>

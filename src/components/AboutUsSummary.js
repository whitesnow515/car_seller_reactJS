...
export default function AboutUsSummary() {
    return (
        <div
            className="flex justify-center align-center lg:py-[7rem] max-w-[1140px] mx-auto lg:mb-36 mb-5">
            <div className='flex  lg:flex-row flex-col justify-center items-center lg:items-start p-5'>
                <div className=" px-3 min-w-[400px] max-w-[600px] relative">
                    <Typography
                        variant="h1"
                        color="black"
                        className="absolute top-0 z-10 bg-white p-2 scale-y-110 rounded-md">
                        About Us
                    </Typography>
                    <CustomCarousel>
                        <img
                ...
                <div className="px-3  min-w-[500px] max-w-[600px] -mt-6 ">
                    <p
                        className="mt-16 lg:mt-0 py-4 text-gray-800 font-barlow text-2xl font-semibold leading-8">
                    ...
                    <div className='flex flex-row justify-center items-center mt-6 gap-4'>
                        <a href="tel:01252943974"
                            className="bg-gray-900 font-semibold text-base rounded-full text-white border-2 border-gray-900 hover:bg-black hover:text-white py-2 px-3 text-center"
                            formNoValidate="formnoValidate">
                            Speak To An Advisor
                        </a>
                        <Link to="/contact-us"
                            className="bg-white font-semibold text-base rounded-full text-black border-2 border-black hover:bg-black hover:text-white py-2 px-3 text-center"
                            formNoValidate="formnoValidate">
                            Visit Us
                        </Link>

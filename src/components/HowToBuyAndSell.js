                        ...
                        <div className='flex flex-wrap mb-[48px]'>
                            <div className="w-full lg:w-1/3 p-3">
                                <div className="w-full flex">
                                    <div
                                        className='w-[70px] h-[70px] rounded-[50px] bg-gray-900 text-white text-[40px] font-normal text-center'>1</div>
                            ...
                            <div className="w-full lg:w-1/3 p-3">
                                <div className="w-full flex">
                                    <div
                                        className='w-[70px] h-[70px] rounded-[50px] bg-gray-900 text-white text-[40px] font-normal text-center'>2</div>
                            ...
                            <div className="w-full lg:w-1/3 p-3 ">
                                <div className="w-full flex">
                                    <div
                                        className='w-[70px] h-[70px] rounded-[50px] bg-gray-900 text-white text-[40px] font-normal text-center'>3</div>

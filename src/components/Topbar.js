            ...
            <ul className="flex me-3 w-fit">
                <li className="flex items-center mx-2">
                    ...
                    <div
                        ...
                        <Link
                            to="/shortlist"
                            className="text-white font-saira-condensed text-base font-medium leading-6 tracking-tighter uppercase">SHORTLIST</Link>
                    </div>
                </li>
                <li className="flex items-center mx-2">
                    <div onClick={chat} className="flex items-center cursor-pointer  mr-1">
                ...
                <li className="flex items-center mx-2">
                    ...
                    <div
                        className="text-white font-saira-condensed text-base font-medium leading-6 tracking-tighter uppercase">TALK ON LIVCHAT</div>

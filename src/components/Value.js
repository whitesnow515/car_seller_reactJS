...
export default function Value() {
    ...
    return (
        <div className="w-full h-fit  custom-gradients px-24 flex justify-center items-center lg:py-[100px] py-[50px]">
            <div className="max-w-[1280px]  w-full flex flex-wrap justify-evenly">

...
const SITEMAP = [
    {
        ...
        links: ["The Goodwood Building, The Yard, Oakhanger ", "Bordon, GU35 9JU", "Careers", "Our Team", "Projects"]
    }, {
        ...
        title: "Links",
        links: ["Home./", "Site Map./sitemap/", "Disclaimer./disclaimer/", "Privacy Policy./privacy-policy/", "Cookie Policy./cookies-notice/", "FCA Disclaimer./fca-disclaimer"]
    }
];
        ...
        <footer className="w-full  px-7 md:pl-24 md:pr-20 pt-[50px] md:pt-[100px] pb-8 md:pb-[96px]  font-inter bg-svg-background">
            <div className="w-full max-w-[1280px] mx-auto">
                <div className="w-full flex flex-col md:flex-row md:justify-between ">
                    <div className="w-full  md:w-fit flex flex-col md:justify-start items-cente">
                        <img id="nav-logo" itemProp="logo" alt="TMC Logo" src={logo} className='w-26  font-inter h-12' />
                        <ul className="mt-12 md:mt-9 flex nav--social  font-inter ">
                            <a href="https://www.facebook.com/tmcmotorsales">
                            <li className="flex items-center mr-2">
                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12.2005 13.2466V17.0834H15.5926C17.1667 17.0834 17.1667 15.5093 17.1667 15.5093V4.88434C17.1667 2.91675 15.5926 2.91675 15.5926 2.91675H4.57407C4.57407 2.91675 3 2.91675 3 4.88434V15.5093C3 17.0834 4.57407 17.0834 4.57407 17.0834H9.84162V13.2466H8.0069V11.1151H9.84162V8.32763C9.84162 8.32763 9.84162 6.85193 11.4142 6.85194L14.0353 6.85193V9.06547H12.2005V11.1151H14.0353V13.2466H12.2005Z" fill="white" />
                                </svg>
                            </li>
                            </a>
                            ...
                            <li className="flex items-center mr-2">
                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12.2678 8.23223C13.2441 9.20854 13.2441 10.7915 12.2678 11.7678C11.2915 12.7441 9.70854 12.7441 8.73223 11.7678C7.75592 10.7915 7.75592 9.20854 8.73223 8.23223C9.70854 7.25592 11.2915 7.25592 12.2678 8.23223Z" fill="#676A71" />
                                    <path d="M13.7812 2.5H7.21875C4.89239 2.5 3 4.39239 3 6.71875V13.2812C3 15.6076 4.89239 17.5 7.21875 17.5H13.7812C16.1076 17.5 18 15.6076 18 13.2812V6.71875C18 4.39239 16.1076 2.5 13.7812 2.5ZM10.5 13.75C8.43228 13.75 6.75 12.0682 6.75 10C6.75 7.93183 8.43228 6.25 10.5 6.25C12.5677 6.25 14.25 7.93183 14.25 10C14.25 12.0682 12.5677 13.75 10.5 13.75ZM14.7188 6.25C14.4599 6.25 14.25 6.04012 14.25 5.78125C14.25 5.52233 14.4599 5.3125 14.7188 5.3125C14.9776 5.3125 15.1875 5.52233 15.1875 5.78125C15.1875 6.04012 14.9776 6.25 14.7188 6.25Z" fill="white" />
                                </svg>
                            ...
                            <li className="flex items-center mr-2">
                                <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0.166504 4.75C0.166504 2.54086 1.95737 0.75 4.1665 0.75H12.8332C15.0423 0.75 16.8332 2.54086 16.8332 4.75V9.25C16.8332 11.4591 15.0423 13.25 12.8332 13.25H4.1665C1.95737 13.25 0.166504 11.4591 0.166504 9.25V4.75Z" fill="white" />
                                    <path d="M7.0293 7.47926V6.64096C7.0293 5.8729 7.85923 5.39156 8.52589 5.77297L9.31488 6.22437C10.011 6.62261 9.97863 7.63711 9.25859 7.99021L8.46959 8.37712C7.80517 8.70294 7.0293 8.21927 7.0293 7.47926Z" fill="black" stroke="black" strokeWidth="1.5" />
                                </svg>
                    ...
                    <div className="mt-12 md:mt-0">
                        ...
                        <Typography as="li" color="white" className="font-normal text-base mb-2 flex flex-row">
                            ...
                            <div>6 Barge Street,<br />Huddersfield, HD1 3LN</div>
                        </Typography>
                        <p className="">
                            <a href="tel:01484 482511" className="flex text-white text-decoration-none">
                                +7 (708) 802 88 88
                            </a>
                        </p>
                    </div>
                    <div className="mt-12 md:mt-0">
                        <Typography variant="small" color="white" className="mb-4 font-bold  font-inter text-xl">
                            Opening Hours
                        </Typography>
                        {SITEMAP[2]
                            .links
                            .map((link, key) => (
                                <div className="flex justify-between py-[1px]" key={key}>
                                    ...
                                    <Typography key={key+"2"} as="li" color="white" className="font-normal  font-inter text-base">
                                        {link.split('.')[1]}
                                    </Typography>
                                </div>
                            ))}
                                ...
                                {SITEMAP[3]
                                    ...
                                    .map((link, key) => (
                                        <Typography
                                            ...
                                            <Link to={link.split('.')[1]} className="font-normal text-base hover:scale-105">
                                                {link.split('.')[0]}
                                            </Link>
                                        </Typography>
                                    ))}

...
export default function Blog() {
    ...
    return (
        <MainLayout>
            ...
            <div className="md:px-11 p-3 w-full  max-w-[1600px] mx-auto">
                <Tabs id="custom-animation" value="All">
                    <TabsHeader
                        ...
                        <div
                            className="flex lg:flex-row flex-col w-full lg:justify-between justify-center items-center">
                                ...
                                {data.map(({label, value}) => (
                                    <Tab
                                        ...
                                        <div
                                            ...
                                            ? " text-black"
                                            : "bg-gray-900 text-white "} uppercase border-gray-800 border rounded-full text-center cursor-pointer text-base font-semibold px-3 py-2 no-underline transition-all duration-150 ease-in-out align-middle`}>
                                            {label}&nbsp;{label === "All"
                                                ? "review"
                                                : ""}
                                        </div>
                            ...
                            <div className="flex lg:mt-0 mt-3 lg:w-fit w-full items-center justify-center">
                                <div
                                    className="rounded-full w-full sm:w-2/3 lg:w-fit border border-gray-600 px-3 items-center text-center">
                                    <Select value="Newest" variant="standard" className="p-0 border-none">
            ...
            <div
                className="max-w-[1240px] bg-gray-100 w-full mx-auto  px-8 py-[50px] bg-neutral-100 rounded-3xl flex-col justify-start items-center gap-8 hidden md:flex">
                <div

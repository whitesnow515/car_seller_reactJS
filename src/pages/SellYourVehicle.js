...
export default function SellYourVehicle() {
  ...
  return (
    <MainLayout>
      {openQuick ? (
        <>
          <HeroSection img={sellcars} overBGh={"1/3"} words={["Sell", "Your", "Vehicle"]} />
          <div className="w-full flex flex-col md:flex-row justify-center items-center py-[100px]  px-[20px] md:px-0">
            <div className="w-full flex flex-col md:flex-row justify-between max-w-[1280px]">
              <div className="max-w-[535px] ">
                <div className="text-gray-900 scale-y-125 font-barlow-condensed text-6xl font-bold leading-tight uppercase">
                  WE MAKE
                </div>
                <div className="text-gray-900  scale-y-125  font-barlow-condensed text-6xl font-bold leading-tight uppercase">
                  SELLING EASY!
                ...
                <p className="mt-6">At TMC, we are always looking to buy high quality used trucks and cars. So whether you're selling or part exchanging we always provide the very best prices! We can also settle any outstanding finance too! We specialise in used pick-up trucks, vans and used cars and have vast experience with all aspects of the used vehicle market and our sales team will be delighted to make the experience an enjoyable one for you.</p>
                <div className="mt-8"></div>
                <p className="">We value each vehicle on an individual basis by looking at its condition, specifications and history, rather than the book value alone – so if it is the right car or van for us, we would be happy to pay more than its estimated market value. We have been purchasing used trucks and cars for many years and, when available, will travel to you wherever necessary in order to make the transaction as smooth as possible</p>
              </div>
                ...
                <div className="mt-12 p-8 rounded-lg bg-gray-200">
                  ...
                  <div className="lg:hidden flex flex-col justify-center items-center">
                    <div className=" mt-12   lg:hidden flex flex-row justify-between w-full bg-white rounded-full border-2 border-gray-300 text-gray-700 font-saira-condensed font-medium text-base leading-6" >
                      <input type="text " className="h-12 ml-6 w-full outline-none" placeholder="Enter your registration number" />
                    ...
                    <div className="hover:text-white text-center mt-8 w-fit hover:cursor-pointer bg-white rounded-full text-black py-3 px-6 hover:bg-gray-800 shadow-lg">
                      GEET A QUICK VALUATIONS
                    </div>
                  </div>


                  {/* <div className="md:hidden block mt-6 flex flex-col justify-center itmes-center">
                <div className=" px-6 h-12 flex flex-col justify-center items-center w-full bg-white rounded-full border-2 border-gray-300 text-gray-700 font-saira-condensed font-medium text-base leading-6" >
                  <input type="text test" className="outline-none" placeholder="Enter your registration number" />
                </div>
                <div className="mt-2 rounded-full text-white py-3 text-center bg-gray-800 shadow-lg">
                  GEET A QUICK VALUATIONS
                </div>
              </div> */}
          ...
          <div className="w-full flex justify-center items-center px-[20px] md:px-0">
            <div className="w-full max-w-[1280px] flex flex-wrap  justify-between">
              <div className="flex flex-col justify-center items-center">
                <div className="p-4 rounded-xl border border-gradient bg-gradient-to-r from-red-500 to-blue-500">
                  <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M25.4505 7.33331C25.1836 6.53319 24.4505 6 23.5833 6H8.91669C8.0495 6 7.31644 6.53319 7.0495 7.33331L4.25 14.6667V24.6667C4.25 25.3997 4.85025 26 5.58331 26H6.91669C7.64975 26 8.25 25.3997 8.25 24.6667V24H24.25V24.6667C24.25 25.3997 24.8503 26 25.5833 26H26.9167C27.6497 26 28.25 25.3997 28.25 24.6667V14.6667L25.4505 7.33331ZM8.91669 20C7.78388 20 6.91669 19.1334 6.91669 18C6.91669 16.8666 7.78388 16 8.91669 16C10.0495 16 10.9167 16.8666 10.9167 18C10.9167 19.1334 10.0495 20 8.91669 20ZM23.5833 20C22.4505 20 21.5833 19.1334 21.5833 18C21.5833 16.8666 22.4505 16 23.5833 16C24.7161 16 25.5833 16.8666 25.5833 18C25.5833 19.1334 24.7161 20 23.5833 20ZM6.91669 13.3333L8.91669 8H23.5833L25.5833 13.3333H6.91669Z" fill="white" />
                  </svg>
                </div>
              ...
              <div className="flex flex-col justify-center items-center">
                <div className="p-4 rounded-xl border border-gradient bg-gradient-to-r from-red-500 to-blue-500">
                  <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.15001 6.3999C5.3827 6.3999 3.95001 7.83259 3.95001 9.5999V11.1999H29.55V9.5999C29.55 7.83259 28.1173 6.3999 26.35 6.3999H7.15001Z" fill="white" />
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M29.55 14.3999H3.95001V22.3999C3.95001 24.1672 5.3827 25.5999 7.15001 25.5999H26.35C28.1173 25.5999 29.55 24.1672 29.55 22.3999V14.3999ZM7.15001 20.7999C7.15001 19.9162 7.86636 19.1999 8.75001 19.1999H10.35C11.2337 19.1999 11.95 19.9162 11.95 20.7999C11.95 21.6836 11.2337 22.3999 10.35 22.3999H8.75001C7.86636 22.3999 7.15001 21.6836 7.15001 20.7999ZM15.15 19.1999C14.2664 19.1999 13.55 19.9162 13.55 20.7999C13.55 21.6836 14.2664 22.3999 15.15 22.3999H16.75C17.6337 22.3999 18.35 21.6836 18.35 20.7999C18.35 19.9162 17.6337 19.1999 16.75 19.1999H15.15Z" fill="white" />
                  </svg>
              ...
              <div className="mt-8 md:mt-0 flex flex-col justify-center items-center">
                <div className="p-4 rounded-xl border border-gradient bg-gradient-to-r from-red-500 to-blue-500">
                  <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M16.25 28.8002C23.3192 28.8002 29.05 23.0694 29.05 16.0002C29.05 8.93095 23.3192 3.2002 16.25 3.2002C9.18075 3.2002 3.45 8.93095 3.45 16.0002C3.45 23.0694 9.18075 28.8002 16.25 28.8002ZM17.25 9.60019C17.25 9.04791 16.8023 8.60019 16.25 8.60019C15.6977 8.60019 15.25 9.04791 15.25 9.60019V16.0002C15.25 16.2654 15.3554 16.5198 15.5429 16.7073L20.0684 21.2328C20.4589 21.6233 21.0921 21.6233 21.4826 21.2328C21.8731 20.8423 21.8731 20.2091 21.4826 19.8186L17.25 15.586V9.60019Z" fill="white" />
                  </svg>
              ...
              <div className="mt-8 md:mt-0 flex flex-col justify-center items-center">
                <div className="p-4 rounded-xl border border-gradient bg-gradient-to-r from-red-500 to-blue-500">
                  <svg width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.55 19.2002V24.0002C5.55 26.6512 10.5644 28.8002 16.75 28.8002C22.9356 28.8002 27.95 26.6512 27.95 24.0002V19.2002C27.95 21.8512 22.9356 24.0002 16.75 24.0002C10.5644 24.0002 5.55 21.8512 5.55 19.2002Z" fill="white" />
                    <path d="M5.55 11.2002V16.0002C5.55 18.6512 10.5644 20.8002 16.75 20.8002C22.9356 20.8002 27.95 18.6512 27.95 16.0002V11.2002C27.95 13.8512 22.9356 16.0002 16.75 16.0002C10.5644 16.0002 5.55 13.8512 5.55 11.2002Z" fill="white" />
                    <path d="M27.95 8.0002C27.95 10.6512 22.9356 12.8002 16.75 12.8002C10.5644 12.8002 5.55 10.6512 5.55 8.0002C5.55 5.34923 10.5644 3.2002 16.75 3.2002C22.9356 3.2002 27.95 5.34923 27.95 8.0002Z" fill="white" />
                  </svg>
            ...
            <div className="w-full max-w-[1280px] flex flex-col md:flex-row justify-between">
              ...
              <div className="mt-6 md:mt-0 flex flex-row">
                ...
                <div className="ml-8 max-w-[284px] flex flex-col">
                  ...
                  <div className="text-gray-800 font-barlow text-base font-normal leading-7">No advertising fees, strangers, nuisance callers or tyre-kickers on your doorstep. We pay your money directly to your bank account, collect your vehicle when possible, and can also settle outstanding finance prior to sale.</div>
                </div>
              </div>
              <div className="mt-6 md:mt-0 flex flex-row">
                <div className="mt-4">
                ...
                <div className="max-w-[284px] ml-8 flex flex-col">
                  ...
                  <div className="text-gray-800 font-barlow text-base font-normal leading-7">It could be more than you would expect - higher than what you’ll get from many dealers in part exchange, or from online buying services.</div>
                </div>
              </div>
            </div>
          </div>
        </>) : (<>
          <div className="bg-[#f6f6f6] py-[50px] max-w-[1360px] mx-auto ">
            <div className="w-3/5 mx-auto">
              <div className="flex flex-col bg-white rounded-2xl p-8">
                <div className="uppercase text-2xl  scale-y-125 font-bold">get a quick valuation on your vehicle</div>
                <div>Input your car info and get your vehicle quick valuation</div>
                <div className="mt-8">Registration Number</div>
                <input type="text" className="mt-2 w-full bg-[#f6f6f6] border-2 border-gray-200 rounded-full py-3 px-6"></input>
                <div className="mt-4 flex flex-wrap flex-row justify-between">
                  <div className="flex flex-col">
                    <div className="">Make/Brand</div>
                    <input type="text" className="mt-2 w-[90%] bg-[#f6f6f6] border-2 border-gray-200 rounded-full py-3 px-6"></input>
                  </div>
                  <div className="flex flex-col">
                    <div className="">Make/Brand</div>
                    <input type="text" className="mt-2 w-[90%] bg-[#f6f6f6] border-2 border-gray-200 rounded-full py-3 px-6"></input>
                ...
                <div className="mt-4">Fuel Type</div>
                <input type="text" className="mt-2 w-full bg-[#f6f6f6] border-2 border-gray-200 rounded-full py-3 px-6"></input>
                <div className="mt-4">Year Manufacture</div>
                <input type="text" className="mt-2 w-full bg-[#f6f6f6] border-2 border-gray-200 rounded-full py-3 px-6"></input>
                <div className="mt-4">Engine Size</div>
                <input type="text" className="mt-2 w-full bg-[#f6f6f6] border-2 border-gray-200 rounded-full py-3 px-6"></input>
                <div className="mt-4 flex flex-wrap flex-row justify-between">
                  <div className="flex flex-col">
                ...
                <div className="mt-8 flex flex-wrap flex-row justify-between">
                  <div className="uppercase py-2 px-8 rounded-full border-2 border-black bg-white hover:text-white hover:bg-black">cancel</div>
                  <div className="uppercase py-2 px-8 rounded-full border-2 border-black bg-white hover:text-white hover:bg-black">continue</div>
                </div>
              </div>
            </div>
          </div>

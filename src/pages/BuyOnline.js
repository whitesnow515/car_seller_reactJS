...
import { FeaturedVehiclesTab } from "../components/gallery/FeaturedVehiclesTab"
    ...
    return (
        <MainLayout>
            ...
            <div className="w-full h-fit  px-12 lg:px-24 flex justify-center items-center pb-12 md:pb-0">
                <div className="block flex md:flex-row md:justify-between  gap-5  w-full max-w-[1360px] py-[100px] flex-col">
                    <div className='w-full md:mx-0 mx-auto md:self-start md:w-[43%]'>
                        <div className="text-gray-800 text-6xl leading-10 uppercase  scale-y-125 py-2 font-barlow-condensed text-6xl font-bold leading-none tracking-tighter">
                            Buy online Safely
                        </div>
                        <div className="mt-10 md:mt-0 text-gray-800 text-6xl leading-10 uppercase  scale-y-125 py-2 font-barlow-condensed text-6xl font-bold leading-none tracking-tighter">
                            and easily with
                        </div>
                        <div className="mt-10 md:mt-0 text-gray-800 text-6xl leading-10 uppercase  scale-y-125 py-2 font-barlow-condensed text-6xl font-bold leading-none tracking-tighter ">
                            TMC.
                        </div>
                        <div className="mt-6 text-black font-barlow text-base font-normal leading-8">
                        ...
                        <div className="test-center rounded-full w-fit py-3 px-8 mt-6 text-black hover:text-white bg-white hover:bg-black border-2 border-black hover:cursor-pointer uppercase">search available in buy online</div>
                    </div>
            ...
            <div className="py-12 lg:py-[7rem] w-full bg-gray-200">
                <div className="max-w-[1360px] w-full mx-auto">
                    <div className="flex flex-col justify-center items-center">
                        <FeaturedVehiclesTab title1="new on" title2="buy online" />
                        <Link

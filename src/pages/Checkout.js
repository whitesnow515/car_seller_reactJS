    ...
    <MainLayout>
      <div className="w-full bg-[#F6F6F6] lg:py-8 lg:px-[100px] py-6 px-5">
        <div className="flex flex-col md:flex-row md:justify-between">
          ...
          <div className="flex flex-col md:w-[70%] w-full md:order-2 order-1">
            ...
            <div className="mt-8 bg-white rounded-xl p-8 flex flex-col">
              ...
              <div className="mt-8 w-full flex justify-between">
                <div className="rounded-full border-black border-2 py-2 px-4 uppercase bg-white hover:bg-black text-black hover:text-white hover:cursor-pointer">
                  Cancel
                </div>
                {curtab!==2?<div
                  className="rounded-full border-black border-2  py-2 px-4 uppercase bg-white hover:bg-black text-black hover:text-white hover:cursor-pointer"
                  onClick={next}
                >
                  continue
                </div>:
                <div
                  className="rounded-full border-black border-2 flex flex-row items-center py-2 px-4 uppercase bg-white hover:bg-black text-black hover:text-white hover:cursor-pointer"
                  onClick={next}
                >
                  confirm payoment
                  <svg

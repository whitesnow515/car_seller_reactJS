    ...
    return (
        <MainLayout>
            <HeroSection
                ...
                mt={"mt-20"}/>
            <div
                className="h-fit w-full mx-auto max-w-[1440px]  px-5 sm:px-[30px] md:px-[50px] lg:px-[80px] xl:px-[100px] pt-[100px] bg-white justify-center items-start gap-[50px] flex xl:flex-row flex-col">

                <div
                    className="xl:w-1/2 w-full flex-col justify-start items-start gap-6 inline-flex">
                    <div
                        className="xl:w-[1117px] text-neutral-800 text-center text-7xl font-bold font-['Barlow Condensed'] uppercase leading-[80px]">The Road to Peace of Mind</div>
                    <div
                    ...
                    <div
                        className="self-stretch text-black text-xl font-normal font-['Barlow'] leading-loose">A
                ...
                <div
                    className="xl:w-1/2 w-full mt-0 lg:mt-[120px] self-stretch flex-col justify-start items-center gap-8 inline-flex">
                    <div
                        className="self-stretch justify-start items-start gap-1 flex flex-wrap lg:flex-row">
                        <div
                            className="grow shrink basis-0 p-1 min-w-[200px] lg:min-w-[100px] bg-gray-100 rounded-2xl flex-col justify-center items-center gap-4 inline-flex">
                            <div
                            ...
                            <div
                                className="self-stretch text-center text-neutral-800 text-2xl font-semibold font-['Barlow'] leading-loose">Underwritten by TMC</div>
                        </div>
                        <div
                            className="grow shrink basis-0 p-1 min-w-[200px] lg:min-w-[100px] bg-gray-100 rounded-2xl flex-col justify-center items-center gap-4 inline-flex">
                            <div
                            ...
                            <div
                                className="self-stretch text-center text-neutral-800 text-2xl font-semibold font-['Barlow'] leading-loose">Highest Level of Cover</div>
                        </div>
                        <div
                            className="grow shrink basis-0 min-w-[200px] lg:min-w-[100px] p-1 bg-gray-100 rounded-2xl flex-col justify-center items-center gap-4 inline-flex">
                            <div
                                className="p-4 bg-gradient-to-r from-red-600 to-blue-700 rounded-2xl border border-red-600 justify-center items-center gap-1 inline-flex">
                                <div className="w-8 h-8 relative"><DolarSVG/></div>
                            </div>
                            <div
                                className="self-stretch text-center text-neutral-800 text-2xl font-semibold font-['Barlow'] leading-loose">Up to £3,000 Claim Limit</div>
                        </div>
                    </div>
                    <div
            ...
            <div
                className="max-w-[1440px]  px-[100px] pt-[50px] mx-auto bg-white justify-start items-center gap-[50px] ">
                ...
                <div
                    className="self-stretch pt-10 text-black text-xl font-normal font-['Barlow'] leading-loose">From
            ...
            <div
                ...
                <div
                    className="self-stretch text-center text-neutral-800 text-[32px] font-bold font-['Barlow Condensed'] uppercase leading-10">
                ...
                <div className="md:w-fit md:mx-auto mt-8">
                    <div
                        ...
                        <div
                            ...
                            <div
                                className="text-white text-sm font-semibold font-['Barlow'] uppercase leading-snug tracking-tight">Request a warranty</div>
                        </div>
                        <div

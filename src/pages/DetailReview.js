...
export default function DetailVideo() {
    ...
    return (
        <MainLayout>
            ...
            <div
                className="max-w-[1440px] px-[20px] xl:px-[100px] md:px-[50px] w-full mx-auto  py-[50px] bg-white justify-center items-start gap-[50px] overflow-auto">
                ...
                <div className=" lg:hidden block w-full p-5">
                    <div className=" flex-col justify-start items-center gap-8 inline-flex">
                        <div className="self-stretch  flex-col justify-start items-center flex">
                            <div
                                className="self-stretch bg-gray-100 rounded-tl-2xl rounded-tr-2xl border border-zinc-100 flex-col justify-start items-start flex">
